...
const QUESTIONS: Array<{ id: string; question: string; key: string; videoUri?: any }> = [
  {
    id: "experience_level",
    question:
...
export default function TextChatBuilder() {
            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                ...
                >
                  ...
                  <Text style={{ color: colors.textMuted, fontSize: 14 }}>{item.date || (item.createdAt?.seconds ? new Date(item.createdAt.seconds * 1000).toLocaleString() : 'Recent Session')}</Text>
                </TouchableOpacity>
              )}
            />
          )}
